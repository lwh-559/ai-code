package com.dorr.aicode.langgraph4j.tools;
...
import com.dorr.aicode.langgraph4j.model.enums.ImageCategoryEnum;
import com.dorr.aicode.manager.AliOSSManager;
...
public class MermaidDiagramTool {
    ...
    public List<ImageResource> generateMermaidDiagram(@P("Mermaid 图表代码") String mermaidCode,
        ...
        try {
            ...
            String cosUrl = aliOSSManager.uploadFile(keyName, diagramFile);
            // 清理临时文件
