...
public class StaticResourceController {
     ...
     */
    @Operation(summary = "访问静态资源", description = "根据 deployKey 和文件路径返回已部署应用的静态资源文件，支持目录重定向和默认 index.html")
    @GetMapping("/{deployKey}/**")
    public ResponseEntity<Resource> serveStaticResource(
            @Parameter(description = "应用部署标识 key", required = true, example = "app_123456")
