...
import com.dorr.aicode.service.ScreenshotService;
import com.dorr.aicode.utils.WebScreenshotUtils;
...
public class ScreenshotServiceImpl implements ScreenshotService {
    ...
    public String generateAndUploadScreenshot(String webUrl) {
        ...
        try {
            // 2. 上传到对象存储
            String ossUrl = uploadScreenshotToCos(localScreenshotPath);
    ...
    private String uploadScreenshotToCos(String localScreenshotPath) {
        ...
        return aliOSSManager.uploadFile(cosKey, screenshotFile);
    }
